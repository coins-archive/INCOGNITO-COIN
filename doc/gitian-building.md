...
- [Building INCOGNITO](#building-incognito)
...
Clone the git repositories for incognito and gitian and then checkout the incognito version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the incognito repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the incognito repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/incognito/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/Crypto-Developer/INCOGNITO
...
./bin/gbuild --commit incognito=${COMMIT} --url incognito=${URL} ../incognito/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit incognito=${COMMIT} --url incognito=${URL} ../incognito/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit incognito=${COMMIT} --url incognito=${URL} ../incognito/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/incognito-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/incognito-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/incognito-build.assert
```
...
[incognito/gitian.sigs](https://github.com/incognito-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
