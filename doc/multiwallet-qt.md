...
In order to support loading of multiple wallets in incognito-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is incognito.cpp.
...
Changes to incognito.cpp
----------------------
incognito.cpp is the entry point into incognito-qt, and as such, will require some minor modifications to provide hooks for
