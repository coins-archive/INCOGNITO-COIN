Incognito Core version 2.3.1 is now available from:
...
Incognito Core is extensively tested on multiple operating systems using
...
Incognito Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Incognito address of payment
