...
This mechanism has been integrated into Bitcore-Node-Incognito which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/digiwage/insight-api-digiwage#web-socket-api](https://github.com/digiwage/insight-api-digiwage#web-socket-api) 
* API: [https://github.com/digiwage/insight-api-digiwage#swifttx-transactions](https://github.com/digiwage/insight-api-digiwage#swifttx-transactions) 
...
By default, the Incognito Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Incognito Core daemon:
