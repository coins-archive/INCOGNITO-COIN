                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("INCOGNITO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a INCOGNITO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and incognito: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About INCOGNITO Core"), this);
    aboutAction->setStatusTip(tr("Show information about INCOGNITO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for INCOGNITO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your INCOGNITO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified INCOGNITO addresses"));
    ...
    openAction->setStatusTip(tr("Open a INCOGNITO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the INCOGNITO Core help message to get a list with possible INCOGNITO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("INCOGNITO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to INCOGNITO network", "", count));
}
...
{
    QString strTitle = tr("INCOGNITO Core"); // default title
