...
/** Utility functions used by the INCOGNITO Qt UI.
 */
namespace GUIUtil
{
...
// Render INCOGNITO addresses in monospace font
...
// Parse "incognito:" URI into recipient object, return true on successful parsing
