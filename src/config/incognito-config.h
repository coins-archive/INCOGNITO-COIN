/* src/config/incognito-config.h.  Generated from incognito-config.h.in by configure.  */
/* src/config/incognito-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef INCOGNITO_CONFIG_H

#define INCOGNITO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://incognito.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Incognito Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Incognito Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "incognito"
