...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("INCOGNITO Core incognito-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  incognito-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded incognito transaction") + "\n" +
                               "  incognito-tx [options] -create [commands]   " + _("Create hex-encoded incognito transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded incognito transaction
