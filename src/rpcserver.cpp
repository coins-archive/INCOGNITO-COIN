...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop INCOGNITO server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "INCOGNITO server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* INCOGNITO features */
        {"incognito", "masternode", &masternode, true, true, false},
        {"incognito", "masternodelist", &masternodelist, true, true, false},
        {"incognito", "mnbudget", &mnbudget, true, true, false},
        {"incognito", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"incognito", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"incognito", "mnsync", &mnsync, true, true, false},
        {"incognito", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"incognito", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use incognitod, or the -server option to incognito-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> incognito-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19393/\n";
}
