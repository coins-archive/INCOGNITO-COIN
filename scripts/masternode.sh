...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='incognito.conf'
CONFIGFOLDER='/root/.incognito'
COIN_DAEMON='incognitod'
COIN_CLI='incognito-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/incognitoproject/Incognito.git'
COIN_TGZ=''
